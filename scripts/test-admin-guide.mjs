...
for(const route of ['admin-setup.html','roster-admin.html','groups-admin.html','schedule-admin.html','live-desk.html','match-admin.html','notification-admin.html','predictions-admin.html','media-admin.html','news-admin.html','feed-admin.html','video-admin.html','document-admin.html','stats-admin.html','qr-generator.html','index.html'])assert(guide.includes(`href="./${route}`),`missing guide route: ${route}`);
...
assert(home.includes('مركز الأخبار والإعلام')&&home.includes('الأخبار والنشرات والصور والفيديو واللوائح في مكان واحد'),'admin home must expose unified media management');
