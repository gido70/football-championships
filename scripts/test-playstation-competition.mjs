...
must(operatorPage.includes('كل هدف يُنشر تلقائيًا للأهالي')&&operatorPage.includes('شاشة اللعب'),'واجهة المشغّل لا تشرح النشر المباشر أو شاشة اللعب');
